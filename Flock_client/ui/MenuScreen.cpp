...
void MenuScreen::render() {
  ...
  Terminal::printAt(10, 10,
                    (selectedIndex == 1 ? Color::green("> [1]  Login") : "  [1]  Login"));
  Terminal::printAt(
      12, 10,
      (selectedIndex == 2 ? Color::green("> [2]  Create Account") : "  [2]  Create Account"));
  Terminal::printAt(
      14, 10, (selectedIndex == 3 ? Color::green("> [3]  Settings") : "  [3]  Settings"));
  Terminal::printAt(16, 10,
                    (selectedIndex == 4 ? Color::green("> [4]  Exit") : "  [4]  Exit"));
